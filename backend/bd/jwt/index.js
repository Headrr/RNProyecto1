...
var jwts = (app, bd) => {
 ...
 app.get('/datos', (req, res) => {
  ...
  app.post("/addUrl", (req, res) => {
    ...
    try {
    bd.query(
      "INSERT INTO cloudinary (idReceta, url) VALUES (?,?)",
      [
        idReceta,
        url
      ],
  ...
  app.get("/getUrl/:id", (req, res) => {
    ...
    try {
      bd.query(`SELECT * from cloudinary where idReceta = ${idReceta}`,
  ...
  app.get('/recetas', (req, res) => {
   ...
   app.get('/recetas/:id', (req, res) => {
    ...
    else return (res.json("Receta no encontrada"))
    // res.json(id);
   });
